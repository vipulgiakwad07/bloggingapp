            ...
            <Box className={classes.wrapper}>
                ...
                <Typography variant="h5" className={classes.text}>I'm a Software Engineer based in India. 
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/vipulgiakwad07" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Typography>
                <Typography variant="h5" className={classes.text}>
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        ...
                        or send me an Email 
                        <Link href="mailto:vipulgaikwad?Subject=This is a subject" target="_blank" color="inherit">
                            <Email />
                        </Link>.
                </Typography>
            </Box>
